...
export default function Nav() {
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 bg-indigo-100">
        <li>
    ...
    <Link to={`/`} className="btn btn-ghost text-xl" onClick={handleHomePageRoute}>Coding News</Link>
  </div>
